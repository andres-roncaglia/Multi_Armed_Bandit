...
Se asume además que la creencia inicial de la probabilidad de ganar para cada máquina sigue una distribución $Beta(2,2)$.

# Resultados

Para obtener una noción de cuanto se ganaría en promedio en un año de juego con la mejor máquina (máquina B).
...
Siendo `r round(promedio_ganancias, 2)` una estimación de la ganancia esperada durante un año de juego con la máquina B.
...
Sin embargo las personas no tienen información acerca de las probabilidades de éxito de las máquinas, por lo que se diseñaron un conjunto de estrategias para descubrir con cual se obtienen mejores resultados. 
...
Consiste en elegir cada día una máquina cualquiera sin importar los resultados que se hayan obtenido en el día anterior.
...
Ventajas de la estrategia:
  ...
  - No se corre el riesgo de concentrarse en una máquina que produciría menos ganancias.
...
La máquina con la que se juega será la que tenga la mayor tasa de éxito hasta el momento  
