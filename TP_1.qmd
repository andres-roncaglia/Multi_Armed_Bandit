...
```{r logo facultad, echo=F, include = T, out.width="80%"}
...
\large
{\bf LICENCIATURA EN ESTADÍSTICA}

\vspace{1cm}

\large
{\bf LA GUÍA DEL APOSTADOR} \\
\vspace{0.3cm}
\normalsize
{\bf "El problema del Bandido Multibrazo"}
...
\doublespacing
{\bf Autores: Franco Santini - Nicolas Gamboa - Andres Roncaglia \\ Docentes: Ignacio Evangelista - Tomás Capretto \\ 2024}
...
Ventajas de la estrategia:
  ...
  - A comparación del método anterior, el riesgo de explotar demasiado una máquina incorrecta en mucho menor.
