...
```
Siendo X variable aleatoria que representa la ganancia total en 1 año de juego y calculando las $P(X_\epsilon<X_{\epsilon')}$ para los $\epsilon$ planteados, concluímos que el óptimo para maximisar las ganancias esperadas es $\epsilon = 0.125$
